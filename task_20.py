...
word = input('введите слово (input word):   ').upper()
letters = {'[AEIOULNSTRАВЕИНОРСТ]' : '1', '[DGДКЛМПУ]' : '2','[BCMPБГЁЬЯ]' : '3', '[FHVWYЙЫ]' : '4', '[KЖЗХЦЧ]' : '5', '[JXШЭЮ]' : '8', '[QZФЩЪ]' : '10' }

for k in letters:
    word = re.sub(k, letters[k], word)
